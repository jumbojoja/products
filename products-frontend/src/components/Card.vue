    ...
    methods: {
        ConfirmNewCard() {
            ...
            axios.post("/card",
                ...
                .then(response => {
                    if (response.data == "1") {
                        ElMessage.success("借书证创建成功") // 显示消息提醒
                    } else {
                        ElMessage.info("借书证创建失败")
                    }
